...
public class ChecksumTreeServer {
  ...
  public ChecksumTreeServer(NamespaceStore nsStore, AbsMillisTimeSource absMillisTimeSource) {
    ...
    checksumTreeGroups = CacheBuilder.newBuilder().maximumSize(mapMaxSize).expireAfterAccess(mapExpirationMinutes,
  ...
  private static class ChecksumTreeKey {
    ...
    public boolean equals(Object other) {
      ...
      return dhtConfigVersion == oKey.dhtConfigVersion && ringIDAndVersionPair.equals(
          oKey.ringIDAndVersionPair) && versions.equals(oKey.versions);
    }
  }
  ...
  public ChecksumNode getRegionChecksumTree_Local(ConvergencePoint cp, RingRegion region, LongInterval versions) {
   ...
   * @return
   */
  private ChecksumTreeGroup computeChecksumTreeGroup(RingIDAndVersionPair ringIDAndVersion, long minVersion,
      long maxVersion) {
   ...
   * @return
   */
  private ChecksumTreeGroup computeChecksumTreeGroup(Collection<RingRegion> regions, long minVersion, long maxVersion,
